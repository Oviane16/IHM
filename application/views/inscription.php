          ...
          <div class="">
            ...
            <div class="clearfix"></div>			
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Formulaire d'inscription</small></h2>
				...
				<div class="x_content">
                    <br />
                    <form id="formInscription" method="post" action="<?php echo site_url("InscriptionController/ajoutUtilisateur") ?>"  class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="prenom">Prenom 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Adresse exacte <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							          <p>
                        M:
                        <input type="radio" class="flat" name="genre" id="genderM" value="M" checked="" required /> F:
                        <input type="radio" class="flat" name="genre" id="genderF" value="F" />
                      </p>
                        </div>
                      </div>
					  
					             <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tel">Num tel <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="tel" name="tel" required="required" class="form-control col-md-7 col-xs-12" data-inputmask="'mask': '999-99-999-99'">
                        </div>
                      </div>
					           <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							             <input type="text" class="form-control" id="dateNaiss" name="dateNaiss" data-inputmask="'mask': '99/99/9999'">
						          </div>
                     </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Confirmer Mot de passe <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="password" class="form-control" id="confirmeMdp" name="confirmeMdp">
                      </div>
                      </div>
...
$(document).ready(function() {
    $('#formInscription').bootstrapValidator({
        container: '#messages',
        feedbackIcons: {
        ...
        fields: {
            ...
            adresse: {
                validators: {
                    notEmpty: {
                        message: 'L\'adresse doit être rempli'
                    }
                }
            },
              tel: {
                validators: {
                    notEmpty: {
                        message: 'Le numero de telephone doit être rempli'
                    }
                }
            },
              mdp: {
                validators: {
                    ...
                    stringLength: {
                       message: 'Le mot de passe doit contenir au moin 4 caractère',
                    ...
                    identical: {
                        field: 'confirmeMdp',
                        message: 'Les mots de passe de coresspondent pas'
                     }
                }
            },
            confirmeMdp: {
              ...
              dateNaiss: {
                validators: {
                    notEmpty: {
                        message: 'La date de naissance doit être remplie'
                    }
                }
            }
        }

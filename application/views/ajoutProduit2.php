...
?>
          ...
          <div class="">
            ...
            <div class="clearfix"></div>			
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Formulaire d'ajout de produitzz</small></h2>
				...
				<div class="x_content">
                    <br />
                      <form id="ajoutProduit" method="post" action="<?php echo site_url("ProduitController/ajoutProduit") ?>" class="form-horizontal form-label-left">
                     ...
                     <div class="form-group">
                      ...
                      <div class="ln_solid"></div>
                       <div class="form-group" >
                       <div id="messages" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"></div>
                       </div>
                     </div>
                      <div class="form-group">
	...
	<script src="<?php echo js_url("js/datepicker/daterangepicker.js")?>" type="text/javascript"></script>

	<script src="<?php echo js_url("vendors/ion.rangeSlider/js/ion.rangeSlider.min.js")?>" type="text/javascript"></script>
	<script src="<?php echo js_url("vendors/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js")?>" type="text/javascript"></script>

	<script src="<?php echo js_url("vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js")?>" type="text/javascript"></script>


	<script src="<?php echo js_url("vendors/jquery-knob/dist/jquery.knob.min.js")?>" type="text/javascript"></script>

	<script src="<?php echo js_url("vendors/cropper/dist/cropper.min.js")?>" type="text/javascript"></script>
